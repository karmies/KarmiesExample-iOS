...
@class CLLocation;
@class CLPlacemark;
enum KarmiesKeyboardStyle : NSInteger;
enum KarmiesCategoryStyle : NSInteger;
enum KarmiesActionStyle : NSInteger;
...
/// Determine the style of keyboard to display (large stickers vs. small emojis), defaults to emojis.
@property (nonatomic) enum KarmiesKeyboardStyle keyboardStyle;
/// Determine the style of categories displayed (no categories vs. multiple categories with tabs above stickers), defaults to tabs.
@property (nonatomic) enum KarmiesCategoryStyle categoryStyle;
/// Determine the style of action for stickers (send with no action vs. a single automatic action vs. a picker for multiple actions), defaults to none.
@property (nonatomic) enum KarmiesActionStyle actionStyle;
...
/// Action style.
typedef SWIFT_ENUM(NSInteger, KarmiesActionStyle) {
  KarmiesActionStyleNone = 0,
  KarmiesActionStyleAutomatic = 1,
  KarmiesActionStylePicker = 2,
};
...
/// Category style.
typedef SWIFT_ENUM(NSInteger, KarmiesCategoryStyle) {
  KarmiesCategoryStyleNone = 0,
  KarmiesCategoryStyleTabs = 1,
};
...
/// Keyboard style.
typedef SWIFT_ENUM(NSInteger, KarmiesKeyboardStyle) {
  KarmiesKeyboardStyleStickers = 0,
  KarmiesKeyboardStyleEmojis = 1,
};
...
/// Determine the style of keyboard to display (large stickers vs. small emojis), defaults to stickers.
@property (nonatomic, readonly) enum KarmiesKeyboardStyle keyboardStyle;
/// Determine the style of categories displayed (no categories vs. multiple categories with tabs above stickers), defaults to none.
@property (nonatomic, readonly) enum KarmiesCategoryStyle categoryStyle;
/// Determine the style of action for stickers (send with no action vs. a single automatic action vs. a picker for multiple actions), defaults to automatic.
@property (nonatomic, readonly) enum KarmiesActionStyle actionStyle;
...
SWIFT_CLASS("_TtC10KarmiesSDK14KarmiesStrings")
@interface KarmiesStrings : NSObject <NSCoding>
@property (nonatomic, copy) NSArray<NSString *> * _Null_unspecified entities;
- (nonnull instancetype)initWithStrings:(NSArray<NSString *> * _Nonnull)strings OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
+ (UIFont * _Nonnull)UIFontFromCTFont:(CTFontRef _Nonnull)font SWIFT_WARN_UNUSED_RESULT;
